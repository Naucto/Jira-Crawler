...
class IssueTypeOrderField(str, Enum):
    CREATED_AT = "CREATED_AT"
    NAME = "NAME"
...
class PullRequestAllowedMergeMethods(str, Enum):
    MERGE = "MERGE"
    REBASE = "REBASE"
    SQUASH = "SQUASH"
...
class RepositorySuggestedActorFilter(str, Enum):
...
class RepositoryVulnerabilityAlertDependencyRelationship(str, Enum):
    DIRECT = "DIRECT"
